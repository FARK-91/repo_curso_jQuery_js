...
/*Clase #9: Delegando carga de trabajo a funciones*/
...
(async function load(){
  ...
  function createTemplate(HTMLString){
    ...
    // El metodo children[0] te posiciona en el primer elemento del container que
    // le estes pasando, para ello antes debes saber si realmente es el primer
    // elemento donde te quieres posicionar, de lo contario puedes ir aumentando else {
    // cero en una posicion segun lo requieras.
